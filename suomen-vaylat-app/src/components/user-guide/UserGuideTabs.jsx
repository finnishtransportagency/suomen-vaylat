...
const StyledTabs = styled.div`
  ...
  &::before {
    ...
    background-color: ${(props) =>
      props.tabIndex === 0 ? 'rgba(0, 99, 175, 1)' : 'rgba(229, 0, 130, 1)'};
    bottom: 0px;
...
const StyledTab = styled.div`
  ...
  cursor: pointer;
  color: ${(props) =>
    props.isSelected ? props.theme.colors.mainWhite : '#656565'};
  text-align: center;
    ...
    },
    {
      ...
      content:
        strings.appGuide.dialogContent.mapLayerMenu.tabsContent.selectedLayers
          ...
          .map((c, index) => {
            return (
              <p key={`userguide_selectedLayers_content_row_${index}`}> {c} </p>
            );
          })
    }
  ];
