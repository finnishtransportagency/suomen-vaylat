...
const Content = () => {
  ...
  useEffect(() => {
    selectedLayers.length > 0 && !updateCustomLayer && store.dispatch(setUpdateCustomLayers(true));
    selectedLayers.length === 0 && updateCustomLayer && store.dispatch(setUpdateCustomLayers(false));
  }, [selectedLayers]);
