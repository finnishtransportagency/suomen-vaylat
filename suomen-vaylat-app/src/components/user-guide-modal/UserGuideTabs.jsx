    ...
    const tabsContent = [
        {
            ...
            content: strings.appGuide.modalContent.mapLevelMenu.tabsContent.allLayers.split('\n').map(c => {
                return ( <p> {c} </p>) 
                 })
        },
        {
            ...
            content: strings.appGuide.modalContent.mapLevelMenu.tabsContent.selectedLayers.split('\n').map(c => {
                return ( <p> {c} </p>) 
                 })
        }
    ];
