...
export const rpcSlice = createSlice({
    ...
    reducers: {
        ...
        setThemeLayers: (state, action) => {
            state.selectedLayersByType.themeLayers = action.payload;
        ...
        mapMoveRequest: (state, action) => {
            state.channel !== null &&
                state.channel.postRequest('MapMoveRequest', [
                    action.payload.x,
                    action.payload.y,
                    typeof action.payload.zoom === 'number'
                        ? action.payload.zoom
                        : 10,
                ]);
        ...
        removeAllSelectedLayers: (state, action) => {
            const groupId =
                (action.payload && action.payload.notRemoveLayersByGroupId) ||
                null;
